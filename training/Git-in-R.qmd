...
GitHub and Azure Devops are examples of storage based services that store git reporitories. They act as as secondary location back up for code and logs managed by the git language. 
...
>>>>>>> deae5081bb59fe4dc3b4aac434f4aea6151c1287
...
For more information on dealing with bug fixes, pull requests and code merging within DevOps:

-   Guide to DevOps - [Pull requests]()

### Three Data States

![[Figure of Git's three main sections](https://git-scm.com/book/en/v2/Getting-Started-What-is-Git)](https://git-scm.com/book/en/v2/images/areas.png)
...
In order to use git within RStudio you must have the directory set up as an R project. Therefore any cloned repository must contain a `Rproj` file.

You can use all the above command line within the terminal window of RStudio, However RStudio also offers a graphical interface that some may find preferable to use. To access open the `Tools` menu and access `Version Control` menu and `Commit...` you can also access with the keyboard short cut `Ctrl+Alt+M`

![Menu access to Version control tools within R Studio](figures/git_in_R_figs/Figure1.png){width="546"}
...
![Version control tools within R studio](figures/git_in_R_figs/Figure2.png){width="722"}

## Further Reading

For a more in depth discussion on Git and how it works : [Pro Git book](https://git-scm.com/book/en/v2)

For information in collaborating on projects within Azure DevOps: Guide to DevOps - Pull requests
